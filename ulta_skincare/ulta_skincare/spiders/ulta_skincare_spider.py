import scrapy
import math
from ulta_skincare.items import UltaSkincareItem 

class UltaSkincareSpider( scrapy.Spider ):
    name = 'ulta_skincare_spider'
    allowed_domains = ['ulta.com']

    start_urls = ['https://www.ulta.com/skin-care?N=2707']

    def parse( self, response ):
        # This parse method will get the urls for all 8 makeup categories
